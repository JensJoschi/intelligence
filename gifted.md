...
The term "gifted" used to be equated with high intelligence, commonly defined as an IQ of two standard deviations above the mean (130 on the most common scale). Giftedness is still used in that way by some societies, e.g. Mensa, though others acknowledge that the term gifted also includes musical or sport talent (Marland 1972); NAGC). The use of the term has changed [...] expand here to include motivation etc. ...] 
The terms"ability" and "talent" differ from above definitions of intelligence. They describe systematically developed skills and knowledge (Gagne 1991; Gagne 1999), including e.g. the ability to self-motivate, learning techniques, but also acting according to social codes. Again, the use of these terms varies depending on viewpoint (e.g. Gardner 1983; Dweck 2006). Ability is therefore highly subjective to the environment that is provided, causing for example poor neighborhoods and ethnic minorities to score consistently worse on ability tests (e.g. SAT in the US, ref). Nurturing or selecting the most "able" is therefore a way to perpetuate social injustice.  [is there a difference between talent and ability?]
In the following we will use the term "gifted" as a synonym of a high IQ, i.e. as a potential that may or may not unfold. We reserve the term "talented" for a person that is able to use this potential.
...
-	Unconventional thinking and humor. Highly intelligent people think outside the box. They may, for example, invent new rules in games, or change the game philosophy by taking rules too literally -	Unconventional thinking and humor. Highly intelligent people think outside the box. They may, for example, invent new rules in games, or change the game philosophy by taking rules too literally [need for good example; e.g. in Monopoly a hotel costs 4 houses + money; if all houses are sold out, buying a hotel becomes impossible]
